...
The participants.tsv file is not required for most modules of the pipeline. However, if you're planning on performing tractometry, computing diffusion metrics in regions of interest or performing harmonization (e.g. using ClinicalCombat) you should provide a `participants.tsv` file with a minimal structure. Minimally, the `participants.tsv` should contain the following columns:

| participant_label | session | run | site | age | sex | handedness | disease |
| --- | --- | --- | --- | --- | --- | --- | --- |
| sub-001 | 1 |  | Sherbrooke | 78 | 2 | 1 | HC |
| sub-001 | 2 |  | Sherbrooke | 78 | 2 | 1 | HC |
| sub-001 | 3 |  | Sherbrooke | 78 | 2 | 1 | HC |
| sub-001 | 4 |  | Sherbrooke | 78 | 2 | 1 | HC |
| sub-001 | 5 |  | Sherbrooke | 78 | 2 | 1 | HC |
| sub-001 | 6 |  | Sherbrooke | 78 | 2 | 1 | HC |
| sub-002 | 1 |  | Sherbrooke | 81 | 2 | 2 | HC |
| sub-002 | 2 |  | Sherbrooke | 81 | 2 | 2 | HC |
| sub-002 | 3 |  | Sherbrooke | 81 | 2 | 2 | HC |
